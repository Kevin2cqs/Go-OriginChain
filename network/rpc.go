...
import (
	...
	"github.com/Kevin2cqs/Go-OriginChain/core"
...
const (
	MessageTypeTx        MessageType = 0x1 //transaction message
	MessageTypeBlock     MessageType = 0x2 //block message
	MessageTypeGetBlocks MessageType = 0x3 //get block message
	MessageTypeStatus    MessageType = 0x4 //state message
	MessageTypeGetStatus MessageType = 0x5 //get state message
	MessageTypeBlocks    MessageType = 0x6 //multiple blocks message
)
